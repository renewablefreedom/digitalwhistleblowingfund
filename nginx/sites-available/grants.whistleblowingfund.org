server {
        ...
        listen [::]:443 ssl http2;
        ssl_certificate /etc/letsencrypt/live/grants.whistleblowingfund.org/fullchain.pem;
        ssl_certificate_key /etc/letsencrypt/live/grants.whistleblowingfund.org/privkey.pem;
        ...
        server_name grants.whistleblowingfund.org;
